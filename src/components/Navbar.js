    ...
    <Header>
      <nav className="web_view">
        ...
        <HamburgerButton
          ...
          onClick={toggleMenu}
        >
          <HamburgerSpan className="top" open={menuOpen} />
          <HamburgerSpan className="middle" open={menuOpen} />
          <HamburgerSpan className="bottom" open={menuOpen} />
        </HamburgerButton>

        {/* Mobile Menu */}
        <MobileMenu id="menu" open={menuOpen}>
          <li>Find Work</li>
          <li>Find Talent</li>
          <li>Articles</li>
          <li>About Us</li>
...
const HamburgerSpan = styled.span`
  ...
  &.top {
    ${({ open }) =>
      open && `transform: rotate(45deg) translateY(6px) translate(6px);`}
  }
